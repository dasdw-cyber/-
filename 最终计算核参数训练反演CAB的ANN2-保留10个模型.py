...
# ======================= 配置区域 =======================
# 输入数据路径 (Step 3 生成的文件)
DATA_PATH = r"E:\叶绿素反演-李文娟老师论文\原始论文中的波段\Prosail-data\核参数一起计算\weiss参数\prosail_training_database_hybrid.csv"

# 模型保存目录
MODEL_SAVE_DIR = r"E:\叶绿素反演-李文娟老师论文\原始论文中的波段\反演Cab-ANN-model\核参数一起算\weiss参数"
